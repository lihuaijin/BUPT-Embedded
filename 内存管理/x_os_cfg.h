...
#ifndef MAIN_SOURCE
extern X_INT32U X_BLOCKSIZE_TABLE[X_MCBNMB];				/* define blocksizetable for each partition */
extern X_INT32U X_BLOCKNUM_TABLE[X_MCBNMB];					/* define blocknumtable for each partition  */
#else
extern X_INT32U X_BLOCKSIZE_TABLE[X_MCBNMB] = X_BLOCKSIZE;	/* define blocksizetable for each partition */
extern X_INT32U X_BLOCKNUM_TABLE[X_MCBNMB] = X_BLOCKNUM;	/* define blocknumtable for each partition  */
#endif
/***************************************         END          ***********************************************/

/***************************************   CORE G.V. DEFINE   ***********************************************/
extern void *pmalloc_table[X_MCBNMB];                        /* pointer of partition after malloc from Heap */
extern X_OS_MEM *gpmem_table[X_MCBNMB];                      /* pointer of MCB					*/
extern SEM_ID semMforPTable[X_MCBNMB];                   	 /* sem use for all partition 			*/                
/***************************************         END          ***********************************************/

extern X_OS_MEM *X_MemFreeList;								/* MCB freeList			*/                            
extern X_OS_MEM X_MemControlBlock[X_MCBNMB];      			/* MCB array			*/         
extern SEM_ID semMforgv;									/* sem for g.v.			*/                                   

extern X_INT8U HeapCount;									/* malloc count from Heap	*/
